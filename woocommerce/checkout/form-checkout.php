<?php
/**
 * Checkout Form — Fashion Feet Premium
 *
...
<p class="ff-checkout-page-title">Secure Checkout</p>
<h1 class="ff-checkout-page-title-main">Checkout</h1>

<form name="checkout" method="post" class="checkout woocommerce-checkout ff-checkout-wrapper" action="<?php echo esc_url( wc_get_checkout_url() ); ?>" enctype="multipart/form-data" aria-label="<?php echo esc_attr__( 'Checkout', 'woocommerce' ); ?>">

	<div class="ff-checkout-left">
	...
	<div class="ff-checkout-right">
		...
		<!-- Trust Badges -->
		<div class="ff-trust-badges">
			<div class="ff-trust-badge">
